...
public class EndUser1 extends Node{
    ...
    public void sendMessage() {
        ...
        messagePacket.packetOut(Constants.E1, 2, message); // send to user2
    ...
    public synchronized void onReceipt(DatagramPacket packet) throws IOException {
        ...
        if(packetContent[0] == Constants.PACKET_OUT)
            ...
            System.out.println("EndUser2: " + new String(packetContent, Constants.HEADER_SIZE, packetContent.length-Constants.HEADER_SIZE).trim() + "\n");
